The Interama (XNT) is cryptocurrency based on Cryptonote algorithm. It's more secure and more anonymous than Bitcoin. Cryptonote is used by several cryptocurrencies included Monero, Bytecoin, Digitalnote ext...
...
Build Interama for 32 bit Android
```
